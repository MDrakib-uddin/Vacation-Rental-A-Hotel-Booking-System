			...
			<div class="container-fluid px-md-0">
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="#" class="img" style="background-image: url('<?php echo APPURL;?>/images/<?php echo $room-> image;?>');"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">BDT <?php echo isset($room->price) ? number_format($room->price, 2) : '0.00'; ?></span> <span class="per">per night</span></p>
	    						<h3 class="mb-3"><a href="rooms/room-single.php?id=<?php echo $room->id ;?>"><?php echo $room->name;?></a></h3>
	    						<ul class="list-accomodation">
	    							<li><span>Max:</span> <?php echo isset($room->person) ? $room->person : '2'; ?> Persons</li>
	    							<li><span>Size:</span> <?php echo isset($room->size) ? $room->size : '50 sq ft'; ?></li>
	    							<li><span>View:</span><?php echo isset($room->view) ? $room->view : 'Sea View'; ?></li>
	    							<li><span>Bed:</span><?php echo isset($room->num_bed) ? $room->num_bed : '1'; ?></li>
	    						</ul>
